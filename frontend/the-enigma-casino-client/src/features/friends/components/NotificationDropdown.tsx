...
export const NotificationDropdown = () => {
  ...
  return (
    <div className="bg-Background-Overlay shadow-sm shadow-black rounded-xl overflow-hidden w-full max-w-[28rem] md:w-[28rem]">


      <div className="p-4 border-b border-Grey-color">
        <h3 className="text-2xl font-bold">Notificaciones</h3>
      </div>
      <div className={`max-h-[30rem] overflow-y-auto ${classes.customScroll}`}>
        <ul>
          {alerts.length === 0 && (
