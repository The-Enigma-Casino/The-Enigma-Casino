...
const GachaMachineSVG: React.FC = () => {
  const ballGreen = "#74c410";
  const ballGolden = "#FFD700";
  const ballRed = "#ce2e2e";
  const ballBlue = "#2457c5";
  const ballPurple = "#7b3fa1";
  const ballOrange = "#d65a1f";
    ...
    >
      <defs>
        <linearGradient id="greenShading" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#74c410" />
          <stop offset="20%" stopColor="#fff58a" />
          <stop offset="30%" stopColor="#74c410" />
          <stop offset="80%" stopColor="#74c410" />
          <stop offset="100%" stopColor="#1F4D2B" />
        </linearGradient>
      </defs>

      <linearGradient id="yellowShading" x1="0%" y1="0%" x2="100%" y2="0%">
        <stop offset="0%" stopColor="#ffdf31" />
        <stop offset="20%" stopColor="#fff58a" />
          <stop offset="30%" stopColor="#ffdf31" />
        <stop offset="60%" stopColor="#ffdf31" />
        <stop offset="100%" stopColor="#c9ad0c" />
      </linearGradient>
...
export default GachaMachineSVG;
